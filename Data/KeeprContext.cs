...
namespace keepr
{
    public class KeeprContext : IdentityDbContext<User>
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=studentprojects.database.windows.net;Database=spencersKeeps;User ID=codeworks@studentprojects;Password=Applejuic3;Trusted_Connection=False;Encrypt=True");
        }
